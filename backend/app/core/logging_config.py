...
def _enhanced_exception_formatter(
    ...
    if log_format == "json":
        ...
        processors.append(
            structlog.dev.ConsoleRenderer(
                colors=True, exception_formatter=_enhanced_exception_formatter
            )
        )
    ...
    def decorator(func):
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                log_method(
                    "Method completed", method=func.__name__, result=repr(result)
                )
